...
{
	public class UniversalToonGUI_Dissolve : UnityEditor.ShaderGUI
	{
		private const string ShaderDefineSHADINGGRADEMAP = "_SHADINGGRADEMAP";
		private const string ShaderDefineANGELRING_ON = "_IS_ANGELRING_ON";
		private const string ShaderDefineANGELRING_OFF = "_IS_ANGELRING_OFF";
		private const string ShaderDefineUTS_USE_RAYTRACING_SHADOW = "UTS_USE_RAYTRACING_SHADOW";
		private const string ShaderPropAngelRing = "_AngelRing";
		private const string ShaderPropRTHS = "_RTHS";
		private const string ShaderPropMatCap = "_MatCap";
		private const string ShaderPropClippingMode = "_ClippingMode";
		private const string ShaderPropClippingMask = "_ClippingMask";
		private const string ShaderPropSimpleUI = "_simpleUI";
		private const string ShaderPropUtsTechniqe = "_utsTechnique";
		private const string ShaderPropAutoRenderQueue = "_AutoRenderQueue";
		private const string ShaderPropStencilMode = "_StencilMode";
		private const string ShaderPropStencilNo = "_StencilNo";
		private const string ShaderPropTransparentEnabled = "_TransparentEnabled";
		private const string ShaderPropStencilComp = "_StencilComp";
		private const string ShaderPropStencilOpPass = "_StencilOpPass";
		private const string ShaderPropStencilOpFail = "_StencilOpFail";
		private const string ShaderPropStencilWriteMask = "_StencilWriteMask";
		private const string ShaderPropStencilReadMask = "_StencilReadMask";
		private const string ShaderPropUtsVersionX = "_utsVersionX";
		private const string ShaderPropUtsVersionY = "_utsVersionY";
		private const string ShaderPropUtsVersionZ = "_utsVersionZ";
		private const string ShaderPropOutline = "_OUTLINE";
		private const string ShaderPropNormalMapToHighColor = "_Is_NormalMapToHighColor";
		private const string ShaderPropIsNormalMapToRimLight = "_Is_NormalMapToRimLight";
		private const string ShaderPropSetSystemShadowsToBase = "_Set_SystemShadowsToBase";
		private const string ShaderPropIsFilterHiCutPointLightColor = "_Is_Filter_HiCutPointLightColor";
		private const string ShaderPropInverseClipping = "_Inverse_Clipping";
		private const string ShaderPropIsBaseMapAlphaAsClippingMask = "_IsBaseMapAlphaAsClippingMask";
		private const string ShaderPropIsLightColor_Base = "_Is_LightColor_Base";
		private const string ShaderPropCameraRolling_Stabilizer = "_CameraRolling_Stabilizer";
		private const string ShaderPropIs_Ortho = "_Is_Ortho";
		private const string ShaderPropGI_Intensity = "_GI_Intensity";
		private const string ShaderPropUnlit_Intensity = "_Unlit_Intensity";
		private const string ShaderPropIs_Filter_LightColor = "_Is_Filter_LightColor";
		private const string ShaderPropIs_LightColor_1st_Shade = "_Is_LightColor_1st_Shade";
		private const string ShaderPropIs_LightColor_2nd_Shade = "_Is_LightColor_2nd_Shade";
		private const string ShaderPropIs_LightColor_HighColor = "_Is_LightColor_HighColor";
		private const string ShaderPropIs_LightColor_RimLight = "_Is_LightColor_RimLight";
		private const string ShaderPropIs_LightColor_Ap_RimLight = "_Is_LightColor_Ap_RimLight";
		private const string ShaderPropIs_LightColor_MatCap = "_Is_LightColor_MatCap";
		private const string ShaderPropIs_LightColor_AR = "_Is_LightColor_AR";
		private const string ShaderPropIs_LightColor_Outline = "_Is_LightColor_Outline";
		private const string ShaderPropInverse_MatcapMask = "_Inverse_MatcapMask";
		private const string ShaderPropUse_BaseAs1st = "_Use_BaseAs1st";
		private const string ShaderPropUse_1stAs2nd = "_Use_1stAs2nd";
		private const string ShaderPropIs_NormalMapToBase = "_Is_NormalMapToBase";
		private const string ShaderPropIs_ColorShift = "_Is_ColorShift";
		private const string ShaderPropRimLight = "_RimLight";
		private const string ShaderPropRimLight_FeatherOff = "_RimLight_FeatherOff";
		private const string ShaderPropAp_RimLight_FeatherOff = "_Ap_RimLight_FeatherOff";
		private const string ShaderPropIs_BlendAddToMatCap = "_Is_BlendAddToMatCap";
		private const string ShaderPropARSampler_AlphaOn = "_ARSampler_AlphaOn";
		private const string ShaderPropIs_UseTweakHighColorOnShadow = "_Is_UseTweakHighColorOnShadow";
		private const string ShaderPropIs_SpecularToHighColor = "_Is_SpecularToHighColor";
		private const string ShaderPropIs_BlendAddToHiColor = "_Is_BlendAddToHiColor";
		private const string ShaderPropAdd_Antipodean_RimLight = "_Add_Antipodean_RimLight";
		private const string ShaderPropLightDirection_MaskOn = "_LightDirection_MaskOn";
		private const string ShaderProp1st_ShadeColor_Step = "_1st_ShadeColor_Step";
		private const string ShaderPropBaseColor_Step = "_BaseColor_Step";
		private const string ShaderProp1st_ShadeColor_Feather = "_1st_ShadeColor_Feather";
		private const string ShaderPropBaseShade_Feather = "_BaseShade_Feather";
		private const string ShaderProp2nd_ShadeColor_Step = "_2nd_ShadeColor_Step";
		private const string ShaderPropShadeColor_Step = "_ShadeColor_Step";
		private const string ShaderProp2nd_ShadeColor_Feather = "_2nd_ShadeColor_Feather";
		private const string ShaderProp1st2nd_Shades_Feather = "_1st2nd_Shades_Feather";
		private const string ShaderPropIs_NormalMapForMatCap = "_Is_NormalMapForMatCap";
		private const string ShaderPropIs_UseTweakMatCapOnShadow = "_Is_UseTweakMatCapOnShadow";
		private const string ShaderPropIs_ViewCoord_Scroll = "_Is_ViewCoord_Scroll";
		private const string ShaderPropIs_PingPong_Base = "_Is_PingPong_Base";
		private const string ShaderPropIs_ViewShift = "_Is_ViewShift";
		private const string ShaderPropIs_BlendBaseColor = "_Is_BlendBaseColor";
		private const string ShaderPropIs_OutlineTex = "_Is_OutlineTex";
		private const string ShaderPropIs_BakedNormal = "_Is_BakedNormal";
		private const string ShaderPropIs_BLD = "_Is_BLD";
		private const string ShaderPropInverse_Z_Axis_BLD = "_Inverse_Z_Axis_BLD";
		private const string ShaderDefineIS_OUTLINE_CLIPPING_NO = "_IS_OUTLINE_CLIPPING_NO";
		private const string ShaderDefineIS_OUTLINE_CLIPPING_YES = "_IS_OUTLINE_CLIPPING_YES";
		private const string ShaderDefineIS_CLIPPING_OFF = "_IS_CLIPPING_OFF";
		private const string ShaderDefineIS_CLIPPING_MODE = "_IS_CLIPPING_MODE";
		private const string ShaderDefineIS_CLIPPING_TRANSMODE = "_IS_CLIPPING_TRANSMODE";
		private const string ShaderDefineIS_TRANSCLIPPING_OFF = "_IS_TRANSCLIPPING_OFF";
		private const string ShaderDefineIS_TRANSCLIPPING_ON = "_IS_TRANSCLIPPING_ON";
		...
		{
			NormalDirectionSizeFix, PositionScaling
		}
		...
		//
		private static _UTS_Transparent _Transparent_Setting;
		private static int _StencilNo_Setting;
		private static bool _OriginalInspector = false;
		private static bool _SimpleUI = false;

		//メッセージ表示用.
		private bool _Use_VrcRecommend = false;

		//Foldoutの初期値.
		private static bool _BasicShaderSettings_Foldout = false;
		private static bool _BasicThreeColors_Foldout = true;
		private static bool _NormalMap_Foldout = false;
		private static bool _ShadowControlMaps_Foldout = false;
		private static bool _StepAndFeather_Foldout = true;
		private static bool _AdditionalLookdevs_Foldout = false;
		...
		private MaterialProperty utsTechnique = null;
	...
	"Select stencil mode that fits you. ");
		...
		private void ApplyQueueAndRenderType(_UTS_Technique technique, Material material) {
		...
		private const string srpDefaultLightModeName = "SRPDefaultUnlit";
		private const string srpDefaultColorMask = "_SPRDefaultUnlitColorMask";
		private const string srpDefaultCullMode = "_SRPDefaultUnlitColMode";
		...
		private void GUI_Outline(Material material) {
			...
			//Enum形式に変換して、outlineMode変数に保持しておく.
			if ((int)_OutlineMode.NormalDirectionSizeFix == _OutlineMode_Setting) {
				outlineMode = _OutlineMode.NormalDirectionSizeFix;
			}
			...
			//値が変化したらマテリアルに書き込み.
			if (outlineMode == _OutlineMode.NormalDirectionSizeFix) {
