...
Shader "Universal Render Pipeline/Toon-Dissolve" {
    Properties{
        ...
        _Tweak_transparency("Tweak_transparency", Range(0, 1)) = 1
...
//ToonCoreEnd
    ...
    CustomEditor "UnityEditor.Rendering.Universal.Toon.ShaderGUI.UniversalToonGUI_Dissolve"
}
