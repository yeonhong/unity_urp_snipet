namespace RoomBuildingStarterKit.Entity
{
    ...
    {
        /// <summary>
        /// The real size of a rectangular floor model.
        /// </summary>
        ...
        /// </summary>
        public Vector3 RightDownLocalPosition { get => this.LeftDownLocalPosition - new Vector3(SIZE, 0f, 0f); }

        /// <summary>
        /// Gets the floor's right down corner's world position.
        /// </summary>
        public Vector3 RightDownWorldPosition { get => this.LeftDownWorldPosition - new Vector3(SIZE, 0f, 0f); }

        /// <summary>
        /// Gets the floor's left up corner's local position.
        /// </summary>
        public Vector3 LeftUpLocalPosition { get => this.LeftDownLocalPosition - new Vector3(0f, 0f, SIZE); }

        /// <summary>
        /// Gets the floor's left up corner's world position.
        /// </summary>
        public Vector3 LeftUpWorldPosition { get => this.LeftDownWorldPosition - new Vector3(0f, 0f, SIZE); }

        /// <summary>
        /// Gets the floor's right up corner's local position.
        /// </summary>
        public Vector3 RightUpLocalPosition { get => this.LeftDownLocalPosition - new Vector3(SIZE, 0f, SIZE); }

        /// <summary>
        /// Gets the floor's right up corner's world position.
        /// </summary>
        public Vector3 RightUpWorldPosition { get => this.LeftDownWorldPosition - new Vector3(SIZE, 0f, SIZE); }
