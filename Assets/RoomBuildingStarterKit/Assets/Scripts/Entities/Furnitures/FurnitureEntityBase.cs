namespace RoomBuildingStarterKit.BuildSystem
{
    ...
    public class FurnitureEntityBase
    {
        ...
        [JsonConstructor]
        public FurnitureEntityBase(FurnitureType furnitureType, FloorEntity floorEntity, CustomVector3 position, CustomVector3 rotation, short direction)
        {
        ...
        /// <param name="direction">The direction.</param>
        /// <param name="floorEntity">The floor entity.</param>
        public FurnitureEntityBase(FurnitureType furnitureType, GameObject furniture, short direction, FloorEntity floorEntity)
        {
            this.FurnitureType = furnitureType;
