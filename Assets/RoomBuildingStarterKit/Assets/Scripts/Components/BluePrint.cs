namespace RoomBuildingStarterKit.BuildSystem
{
    ...
    public class BluePrint : MonoBehaviour
    {
        ...
        {
            this.Assign(JsonConvert.DeserializeObject<BluePrintSerializableData>(data));
        }
        ...
        public void Save(string fileName)
        {
            ...
            {
                SaveLoader.inst.RoomDatas.Add(JsonConvert.DeserializeObject<BluePrintSerializableData>(this.copiedSerializedData));
            }
        }
        ...
        private void Assign(BluePrintSerializableData bluePrint)
        {
            // Floors.
            ...
            if (bluePrint.BluePrintFurnitureEntities.Any())
            {
                this.BluePrintFurnitureEntities = bluePrint.BluePrintFurnitureEntities.Select(f =>
                {
                    ...
                    return new GroundFurnitureEntity(floorEntity, floorEntities, f.Direction, f.FurnitureType, furniture);
                }).ToList();
            }
        }
