namespace RoomBuildingStarterKit.Common
{
    ...
    public class OfficeFloorCollection
    {
        ...
        public void Resize(float MinX, float MinZ, float MaxX, float MaxZ )
        {
            ...
            this.RowCount = (int)(MaxX - MinX) / FloorEntity.SIZE + 1;
            this.ColumnCount = (int)(MaxZ - MinZ) / FloorEntity.SIZE + 1;
        ...
        public OfficeFloorCollection Reset(List<FloorEntity> floorEntities, bool overrideFloorEntity = false)
        {
            ...
            if (this.hasResized == false)
            {
                ...
                this.RowCount = (int)(this.MaxX - this.MinX) / FloorEntity.SIZE + 1;
                this.ColumnCount = (int)(this.MaxZ - this.MinZ) / FloorEntity.SIZE + 1;
            }
            ...
            {
                int x = (int)(this.MaxX - f.LeftDownLocalPosition.x) / FloorEntity.SIZE;
                int y = (int)(this.MaxZ - f.LeftDownLocalPosition.z) / FloorEntity.SIZE;
